...
import { RegisterGuest, RegisterCompetitor, RegisterVendor, RegisterPromoter } from '../screens';
...
function Registration() {
    return (
      <Tab.Navigator tabBarOptions={{ 
          ...
          tabStyle: { borderColor: 'black', borderWidth: 1, paddingBottom: 18, margin: 1, }}}>
