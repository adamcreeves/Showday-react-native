...
function Home(props) {
  ...
  useEffect(() => {
    const unsub = eventRef.orderBy("eventDate", "desc").onSnapshot(
      (querySnapshot) => {
        const newEvents = [];
      ...
      return (
        ...
        >
          {loggedIn === null || user === null ? (
            <TouchableOpacity style={styles.loginLogoutButton} onPress={login}>
                    ...
                    Alert.alert("Delete Event", "Are you sure?", [
                      {
                        text: "Cancel",
                        onPress: () =>
                          console.log("Canceled: event not deleted"),
                        style: "cancel",
                      },
                      {
                        text: "Confirm",
